...
//     const newQuestion:Question = await readBody(event);
//     newQuestion.id = String(Number(questions[questions.length - 1].id) + 1);
...
//           return (
//             (difficultyOrder.indexOf(a.difficulty) - difficultyOrder.indexOf(b.difficulty)) * orderFactor
//           );
//         }
